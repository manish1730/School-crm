...
export default function AllStaff() {
  ...
  const fields = [
    ...
    { name: "gender", label: "Gender", type: "select", options: ["Male", "Female", "Other"].map((item) => ({ label: item, value: item })), required: true },
    ...
    { name: "erpRole", label: "ERP Role", type: "select", options: erpRoles.map((item) => ({ label: item, value: item })), required: true },
